...
::: tip Подсказка 
Клиентам нашего хостинга доступна полностью автоматическая установка панел 3X-UI при первоначальном заказе услуги или с помощью скриптов в панели управления ВМ. Останется только лишь создать пользователей и настроить конфигурации для устройств.
:::
